...
\begin{itemize}[leftmargin=0.05in, label={}]
		\small{\item{
		 ...
		 \textbf{Hardware}{: PCB design, Soldering, Experienced with reading schematics, using oscilloscopes} \\
...
\resumeSubHeadingListStart
		...
		\resumeProject
			{IOT Lights} %Project Name
			{Reverse enginered wirless lights to integrate with Goodle Home} %Project Name, Location Name
			{} %Event Dates

			\resumeItemListStart
			\item {Locally hosted Node based Google Home cloud app}
			\item {Custom hardware to control lights and communicate with cloud app}
			\item {Reversed enginering of Google Home's "actions on Google" API}
			\item {Reversed enginering of wirless protocol}
		\resumeItemListEnd
	\resumeSubHeadingListEnd
\vspace{-8.5mm}
