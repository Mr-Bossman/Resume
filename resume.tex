...
\begin{itemize}[leftmargin=0.05in, label={}]
		\small{\item{
		 \textbf{Languages}{: C, C++, Bash, Verilog, Python, Rust} \\
		 \textbf{Tools \& Technologies}{: Git, KVM, Podman, Linux Kernel, U-Boot, Buildroot, Debian} \\
...
\section{\textbf{Experience}}
	\resumeSubHeadingListStart
		...
		\resumeSubheading
			{Rivos Inc}{Remote}
			{Kernel Developer}{May 2024 - Sep 2024, May 2025 - Aug 2025}
			\vspace{-2.0mm}
			\resumeItemListStart
		...
		\item {Implementing SBI extentions in Rust}
		\resumeItemListEnd
		...
		\resumeSubheading
			{Redhat undergradute capstone}{University of Massachusetts Lowell}
			{Podman next capstone team}{Sep 2025 - Present}
			\vspace{-2.0mm}
			\resumeItemListStart
			\item {Adding named seccomp profiles to Podman}
			\item {Reading and writing Go}
			\item {Updating documentation}
		\resumeItemListEnd
...
\resumeSubHeadingListStart
		\resumeProject
			...
			{Porting of IMXRT and RP2350(Raspberry Pi Pico 2) to the Linux Kernel} %Project Name, Location Name
			{} %Event Dates

			\resumeItemListStart
			\item {Writing Device Trees and Kernel drivers in C}
		...
		\resumeProject
			...
			\item {Used Vidado and Quartus to run on Xilinx and Altera FPGAs}
		...
		\resumeProject
			...
			\item {Locally hosted on servers running Cockpit's KVM Dashboard}
		\resumeItemListEnd
	\resumeSubHeadingListEnd
\vspace{-8.5mm}
...
\section{\textbf{Education}}
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			{Bachelor of Computer Engineering, Minor in Mathematics}{2022-26}
		\resumeSubheading
			{Newton South High School}{}
			{}{2022}
			\resumeItemListStart
			\vspace{-6mm}
			\item {LigerBots - FRC team 2877}
			\item {Science team}
			\resumeItemListEnd
	\resumeSubHeadingListEnd
\vspace{-5.5mm}
